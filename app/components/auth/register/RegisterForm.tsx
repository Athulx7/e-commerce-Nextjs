        ...
        <div className="flex items-center justify-center w-full h-[80vh]">
            <div className="flex flex-col md:flex-row w-11/12 md:w-3/4 h-[475px] mt-5">
                ...
                <div className="flex flex-col items-center justify-center shadow-md p-5 md:w-1/2 bg-white">
                    ...
                    <h2 className="text-center text-cyan-600 font-bold mt-2">WELCOME USER</h2>
                ...
                >
                    ...
                    <h3 className="mt-3 text-xl">Already have an Account?</h3>
                    <p className="mt-4 text-center">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure reiciendis eligendi rem illo voluptate,
                        tempora iste. Quisquam, delectus cumque, consectetur obcaecati, eveniet suscipit incidunt accusantium
                        adipisci voluptate est accusamus nihil!
                    </p>
                    <a
                        href="/auth/login"
